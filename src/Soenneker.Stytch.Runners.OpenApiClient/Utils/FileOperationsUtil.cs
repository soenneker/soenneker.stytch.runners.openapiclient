...
using Soenneker.Stytch.Runners.OpenApiClient.Utils.Abstract;
...
namespace Soenneker.Stytch.Runners.OpenApiClient.Utils;
...
public sealed class FileOperationsUtil : IFileOperationsUtil
{
    ...
    public async ValueTask Process(CancellationToken cancellationToken = default)
    {
        ...
        string openApiDocumentUrl = _configuration["Stytch:ClientGenerationUrl"] ?? "https://raw.githubusercontent.com/stytchauth/stytch-openapi/refs/heads/main/openapi.yml";

        string? filePath = await _fileDownloadUtil.Download(openApiDocumentUrl,
            yamlPath, fileExtension: ".yaml", cancellationToken: cancellationToken);
        ...
        await _kiotaUtil.Generate(fixedPath, "StytchOpenApiClient", Constants.Library, gitDirectory, cancellationToken).NoSync();
